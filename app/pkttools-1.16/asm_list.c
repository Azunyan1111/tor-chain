...
pkt_asm_val_t pkt_asm_list_del_val(pkt_asm_list_t list, pkt_asm_field_t field)
{
  pkt_asm_val_t val;
...
pkt_asm_val_t pkt_asm_list_get_val(pkt_asm_list_t list, pkt_asm_field_t field)
{
  pkt_asm_entry_t entry = NULL, *p;
